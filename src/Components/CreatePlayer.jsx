...
function CreatePlayer(props) {
    ...
    return (
        <form onSubmit={e => {
            ...
            <div> <h2 class="border border-primary p-2 mb-2 border-4 border-primary rounded" style={{ color: "#3434ED", fontFamily: "italic", width: "400px", backgroundColor: "#ffffff6b" }}>New Player Registration</h2>

            </div><div class="border border-primary p-2 mb-2 border-4 border-primary rounded" style={{ marginTop: "30px", marginLeft: "200px", backgroundColor: "#ffffff6b", width: "350px" }}>
